...
the functionality of the City class,
responsible for representing cities within
an application. The tests cover
...
class TestCity_instantiation(unittest.TestCase):
    """
    Test class for City instantiation and attributes
    """

    def test_no_args_instantiates(self):

        """
        Test basic instantiation without arguments
        """
...
"""
Test class for City saving behavior
"""
...
class TestCity_to_dict(unittest.TestCase):
    """
    Test class for City to_dict conversion
    """
