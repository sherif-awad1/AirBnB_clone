...
def split_curly_braces(e_arg):
    """
    Function to split curly braces from the argument
    """
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_EOF(self, arg):
        """
        Method to handle EOF (End Of File)
        """
        return True
    ...
    def do_create(self, arg):
        """
        Method to handle create command
        """
    ...
    def do_destroy(self, arg):
        """
        Method to handle destroy command
        """
        commands = shlex.split(arg)
    ...
    def default(self, arg):
        """
        Method to handle default command
        """
        arg_list = arg.split('.')
        cls_nm = arg_list[0]
...
if __name__ == '__main__':
    """
    If the script is run directly, start the command loop
    """
    HBNBCommand().cmdloop()
